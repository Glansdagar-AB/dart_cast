...
void main() {
  ...
  group('Chromecast integration', () {
    test(
      ...
      final loadMsg = server.sentMessages.firstWhere(
        (m) => m.type == 'LOAD',
      );
      ...
      final seekMsg = server.sentMessages.firstWhere(
        (m) => m.type == 'SEEK',
      );
      ...
      final playMsg = server.sentMessages.firstWhere(
        (m) => m.type == 'PLAY',
      );
    ...
    test('loadMedia sends correct content type for HLS', () async {
      ...
      expect(
        loadMsg.payload['media']['contentType'],
